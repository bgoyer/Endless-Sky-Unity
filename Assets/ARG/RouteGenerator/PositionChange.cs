...
public class PositionChange
{
    ...
    private static float[,] G2CSpline(float[,] posInterData, float[,] vposInterData, float[,] cposInterData, float[,] beta2, float tao)
    {
    ...
    private static float[,] PosAllControl2C(float[,] posInterData, float[,] vposInterData, float[,] cposInterData, float[,] beta2)
    {
        int n = 5; //Bezier曲线的次数是n=5(G^2Hermite插值)  the degree of the Bezier spline for G^2 Hermite interpolation is n=5
    ...
    private static float[,] Jscontrol2C(float[,] z, float[,] v1, float[,] v2, float beta01, float beta11, float beta02, float beta12)
    {
    ...
    private static float[] CBezier(float[,] control, float t)
    {
    ...
    private static float[,] GiveBackPos(List<Vector3> posIniData)
    {
    ...
    private static float[,] GiveBackV(List<Vector3> posIniData)
    {
        int lengh = posIniData.Count;
    ...
    private static float[,] GiveBackA(List<Vector3> posIniData)
    {
        int lengh = posIniData.Count;
    ...
    /// </summary>
    private static float[,] GetBetaC(float[,] vposInterData, float[,] aposInterData, float[,] p)
    {
