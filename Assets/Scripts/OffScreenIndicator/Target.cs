...
namespace Assets.Scripts.OffScreenIndicator
{
    ...
    public class Target : MonoBehaviour
    {
        ...
        [Tooltip("Select if target is a star")]
        [SerializeField] private bool needStarIndicator = false;

        [Tooltip("Select if target is a planet")]
        [SerializeField] private bool needPlanetIndicator = false;

        [Tooltip("Select if target is a enemy outpost")]
        [SerializeField] private bool needEnemyOutpostIndicator = false;

        [Tooltip("Select if target is a asteroid field")]
        [SerializeField] private bool needAsteroidFieldIndicator = false;

        [Tooltip("Select if target is a outpost")]
        [SerializeField] private bool needOutpostIndicator = false;

        [Tooltip("Select if arrow indicator is required for this target")]
        [SerializeField] private bool needArrowIndicator = false;
        ...
        public bool NeedStarIndicator
        {
            get
            {
                return needStarIndicator;
            }
        }

        public bool NeedPlanetIndicator
        {
            get
            {
                return needPlanetIndicator;
            }
        }

        public bool NeedOutpostIndicator
        {
            get
            {
                return needOutpostIndicator;
            }
        }

        public bool NeedAsteroidFieldIndicator
        {
            get
            {
                return needAsteroidFieldIndicator;
            }
        }

        public bool NeedEnemyOutpostIndicator
        {
            get
            {
                return needEnemyOutpostIndicator;
            }
        }
