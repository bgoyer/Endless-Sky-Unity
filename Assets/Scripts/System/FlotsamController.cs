...
namespace Assets.Scripts.System
{
    public class FlotsamController : MonoBehaviour
    {
        ...
        {
            if (col.transform.parent.CompareTag("AIShip") || col.transform.parent.CompareTag("PlayerShip"))
            {
                col.transform.parent.transform.GetComponent<InventoryController>().Add(MatType, MatAmount);
